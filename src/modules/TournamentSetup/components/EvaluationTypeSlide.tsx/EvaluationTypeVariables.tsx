...
export const evaluationTypes: EvaluationTypeOption[] = [
  ...
  },
  {
    ...
    description:
      "In each match, 5 random attributes are selected — 2 of them favor the home contestant (if applicable). Each attribute's difference is multiplied by its category weight, and the winner is based on the final weighted score.",
  },
];
